          ...
          <ul className="space-y-4 list-none p-0">
            {contact.emails?.map((email, i) => (
              <li key={i} className="flex items-start gap-2">
                ...
                <span className="text-neutral-textMuted text-lg break-all">{email}</span>
              </li>
            ))}
            ...
            {contact.phoneNumbers?.map((num, i) => (
              <li key={i} className="flex items-start gap-2">
                ...
                <span className="text-neutral-textMuted text-lg break-all">{num}</span>
              </li>
            ))}
            ...
            {contact.address && (
              <li className="flex items-start gap-2">
                ...
                <span className="text-neutral-textMuted text-lg">{contact.address}</span>
              </li>
            )}
          </ul>
        </div>
